...
trigger: "write Pine Script", "develop indicator", "create strategy", "Pine Script", "new indicator"
---
...
⚠️ **Always compile after every change.** Never claim "done" without a clean compile.

## MCP Tools for Pine Development
...
| `pine_open` | Load saved script by name |