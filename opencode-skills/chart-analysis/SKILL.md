...
trigger: "analyze chart", "technical analysis", "review my chart", "what's on my chart", "analyze ES", "analyze NQ"
---
...
- Use `summary: true` on `data_get_ohlcv`
- Call `chart_get_state` once at start to get indicator entity IDs
- Screenshot is preferred over large data dumps for visual context